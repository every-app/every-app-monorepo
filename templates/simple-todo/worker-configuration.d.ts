/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface Env` (hash: 52d9ce1af76ace565e8ca96b02ff37e5)
// Runtime types generated with workerd@1.20250813.0 2025-08-13 nodejs_compat
declare namespace Cloudflare {
    interface Env {
        todo_app: KVNamespace;
        CORE_APP_URL: string;
        DB: D1Database;
        CORE_APP_SERVICE: Fetcher /* every-app-gateway */;
    }
}
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORE_APP_URL">> { }
}
