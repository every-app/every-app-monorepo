# Deploy Gateway
1. `git clone git@github.com:coolapps-xyz/openeverything-packages.git`
1. `cd cli && pnpm i`
...
1. Run CLI by entering relative path to the openeverything folder
    - e.g. `bun ./openeverything-packages/cli/src/bin/cli.ts app create`
1. Follow prompts
1. Run `npm run dev`
